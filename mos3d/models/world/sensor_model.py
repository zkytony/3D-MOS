...
import random
from mos3d.models.world.objects import TetrisObject
...
class FrustumCamera(CameraModel):
    ...
    def init_render(self):
        near, far = self._params[-2], self._params[-1]
        w1, h1, w2, h2 = self._dim
        vertices = np.array([
            w1/2, h1/2, -near,
            w1/2, -h1/2, -near,
            -w1/2, -h1/2, -near,
        ...
        colors = np.array([
            ...
            0.6, 1, 0.6, 0.8,
            0.6, 0.6, 1, 0.8,
            1, 1, 0.6, 0.8, # rgba; a blue-ish color
        ])
        bcolors=np.array(  # boundary
            [0.15, 0.3, 0.5, 0.9]*8
        )
